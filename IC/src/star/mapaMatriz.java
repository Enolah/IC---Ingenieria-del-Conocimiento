...
public class mapaMatriz {
	...
	/////// METODO PARA ESTABLECER LAS PAREDES EL EL
	/////// LABERINTO///////////////////
	public void setParedes(int x, int y) {
		this.matriz[x][y] = 1;
	}

	////// METODO PARA IMPRIMIR LA
	////// MATRIZ////////////////////////////////////////
	...
	/////// METODO PARA ESTABLECER EL INICIO Y LA
	/////// META///////////////////////////
	...
	/////// METODO QUE INICIALIZA LOS VALORES DE LA
	/////// MATRIZ///////////////////////
	...
	////// METODO QUE EMPIEZA EL ALGORITMO Y REGRESA EL CAMINO
	////// FINAL/////////////
	...
	/////// METODO QUE REALIZA EL ALGORITMO (EN FORMA
	/////// GENERAL)///////////////////
			...
			if (((actual.cordX == puntoMeta.cordX) && (actual.cordY == puntoMeta.cordY)))// ||
				...
				for (int i = 0; i < 3; i++) {
					for (int j = 0; j < 3; j++) {
						...
						if ((!((x >= 0) && (y >= 0) && (x < tamanio) && (y < tamanio) && (matriz[x][y] != 1)))
								|| estaEnCerrados(adyacente)) {
							continue;// lo ignoro
						}

						// consideramos los casos para avance diagonal donde
						// rosa
						nodo extra3;
						if ((adyacente.cordX != actual.cordX) && (adyacente.cordY != actual.cordY)) {
							//// QUITANDO EL CONTINUE Y DESCOMENTANDO LO DE
							//// ABAJO ACEPTAMOS CAMINOS
							//// DIAGONALES///////////////////////////
							////////////////////////////////////////////////////////////////////////////////////////////////////////////
							// continue;
							...
							if (!(adyacente.cordX - 1 < 0)) {// -1 0
								...
								if ((matriz[adyacente.cordX - 1][adyacente.cordY] == 1)
										&& distancia(extra3, actual) == 10) {
									continue;
								}
							}
							// arriba
							...
							if (!(adyacente.cordY + 1 >= tamanio)) {// 0 +1
								...
								if ((matriz[adyacente.cordX][adyacente.cordY + 1] == 1)
										&& distancia(extra3, actual) == 10) {
									continue;
								}
							}
						...
						// comprobamos que no este en la abierta ni en la
						// cerrada
	...
	/////// METODO QUE RECOGE UN NODO ACTUAL Y UNO ADYACENTE Y LE
	/////// PONE///////////
	/////// SUS VALORES RESPECTIVOS DE F,G Y H Y LO
	/////// REGRESA//////////////////////
	...
	/////// METODO QUE VERIFICA SI UN NODO ESTA EN LA LISTA DE
	/////// CERRADOS//////////
	/////// Y REGRESA UN VERDADERO O FALSO SEGUN SEA EL
	/////// CASO/////////////////////
